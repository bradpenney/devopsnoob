              ...
              <div class="row">
                  ...
                  <div class="col-md-8">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Orgainizational Influences and Project Life Cycle</li>
                    </ol>
                    <div class="text-left">
                      ...
                      <p>
                        <strong><span class="glyphicon glyphicon-arrow-right"></span> Next Up: <a href="<?= $siteRoot; ?>/projectManagement/managementProcesses.php">Management Processes</a></strong>
                      </p>
                    </div>
                  </div>
                  <div class="col-md-2">
