              ...
              <div class="row">
                  ...
                  <div class="col-md-8">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Project Integration Management</li>
                    </ol>
                    <div class="text-left">
                      <h2>Project Integration Management</h2>
                      <p class="small">
                          This information is based in large part on the PMBOK&reg; Guide, 5th ed.  The fourth chapter of this guide is "Project Integration Management" and the following is a brief synopsis of that chapter.
                      </p>
                      <p>
                      </p>
                      <p>
