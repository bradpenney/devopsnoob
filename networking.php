                  ...
                  <div class="col-md-8">
                    ...
                    <ul class="list-group">
                      <li class="list-group-item">
                        <h4><a href="./networking/ciscoSwitchCommands.php">Cisco Switch Commands</a></h4>
                        <p>
                      ...
                      <li class="list-group-item">
                        <h4><a href="./networking/decimalToBinary.php">Converting Decimal to Binary</a></h4>
                        <p>
                      ...
                      <li class="list-group-item">
                        <h4>
                            <a href="http://www.vlsm-calc.net/" target="_blank">Variable Length Subnet Mask Calculator</a>
                        </h4>
                        <p>
                      ...
                      <li class="list-group-item">
                        <h4>
                            <a href="http://www.subnetmask.info/" target="_blank">Network Calculators</a>
                        </h4>
                        <p>
