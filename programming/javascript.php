<?php $title = 'Learn JavaScript @ DevOpsNoob.com'; ?>
<?php include '../includes/header.php'; ?>
        	<div class="jumbotron">
        	  <div class="container text-center">
        		<h1>Learn JavaScript @ DevOpsNoob.com</h1>
        	  </div>
        	</div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-8">
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">Learn JavaScript </li>
                      </ol>
                      <p>
                          JavaScript is one of the worlds most popular programming languages.  In recent years, it has stepped outside the web browser and is being used extensively on the server-side (back-end), and even for creating desktop applications and much more.
                      </p>
                      <ul class="list-group">
