              ...
              <div class="row">
                  ...
                  <div class="col-md-8">
                      ...
                      <ul class="list-group">
                          ...
                          <li class="list-group-item">
                              <p>
                                  As I mentioned in the section on front-end web development, W3Schools.com produces some useful tutorials for learning programming.  The PHP tutorial is very useful for both learning and reference:
                              </p>
                              <p>
