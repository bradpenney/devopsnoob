<?php $title = 'Learn Python @ DevOpsNoob.com'; ?>
<?php include '../includes/header.php'; ?>
        	<div class="jumbotron">
        	  <div class="container text-center">
        		<h1>Learn Python @ DevOpsNoob.com</h1>
        	  </div>
        	</div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-8">
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">Learn Python</li>
                      </ol>
                      <p>
                          Python has virtually become the defacto "starter language" over the past couple of years.  Nearly all universities and colleges use Python as an introductory language.  While it is a great place to start learning computer programming, Python is a powerful language that is used by tons of website to run their back-end.  DevOps professionals should be fluent in Python as it is such a multi-purpose language.  I recently began programming in Python, so I posted a few code snippets here (via Github) in the hopes they'll help someone else.  I'll continue to add to this.  Enjoy!
                      </p>
                      <ul class="list-group">
